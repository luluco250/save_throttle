...
// source/contexts/save-api.tsx
var SAVE_TIMEOUT = 1e3;
var SaveApi = class {
  _throttledSave = throttle(SAVE_TIMEOUT, () => this._actuallySave());
  constructor(_onSave) {
  ...
  async _actuallySave() {
    this._onSave?.(/* @__PURE__ */ new Date());
  }
};
var SaveApiContext = createContext();
function SaveApiProvider(props) {
  return createComponent(SaveApiContext.Provider, {
    get value() {
      return new SaveApi(props.onSave);
    },
    get children() {
...
// source/components/save-button.tsx
var _tmpl$ = /* @__PURE__ */ template(`<button type=button>Save`);
function SaveButton() {
...
var _tmpl$2 = /* @__PURE__ */ template(`<h1>`);
function App() {
  const [saveText, setSaveText] = createSignal("Not saved yet.");
  return createComponent(SaveApiProvider, {
    onSave: (timestamp) => {
